...
void plot_vehicleCoordi_wind(const hdMapTrajectory &hdMapTrajectory, const Dt_RECORD_HdmapFrontPLane &HdmapFrontPLane, const Dt_RECORD_EnvModelInfos &envModelInfo, const objSecList &selectObj, PlotItems &plot_items);
...
void plot_lane(const Dt_RECORD_TrajectoryPointsInfos &TrajectoryPoints, const Dt_RECORD_HdmapFrontPLane &HdmapFrontPLane, PlotItems &plot_items);
